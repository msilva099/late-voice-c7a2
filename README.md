...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/late-voice-c7a2)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/late-voice-c7a2
```

A live public deployment of this template is available at [https://late-voice-c7a2.templates.workers.dev](https://late-voice-c7a2.templates.workers.dev)
